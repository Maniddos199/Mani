...
TELEGRAM_BOT_TOKEN = '8159913307:AAEzIU16OGFmLHJMbqod3NISFKq4OEL12FY'
ADMIN_USER_ID = 5797489560
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        ...
        attack_in_progress = False
        await context.bot.send_message(chat_id=chat_id, text="*✅ Attack Completed! ✅*\n*Thank you for using our HAIWANOFFICAL service!*", parse_mode='Markdown')
